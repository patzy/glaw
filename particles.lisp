      ...
      (loop for n from 0 to (range-or-value (particle-emitter-rate em))
         do (let ((part (make-particle)))
              ...
              (setf (particle-sprite part)
                    (create-sprite (range-or-value (particle-emitter-x em))
                                   (range-or-value (particle-emitter-y em))
                                   (range-or-value (particle-emitter-width em))
                                   (range-or-value (particle-emitter-height em))
